...
public class DigonosisFrom extends javax.swing.JFrame {
     ...
     sql="update appointment set pasantname=?,address=?,doctorid=?,doctorname=?,qualification=?,VisitingTime=?,Date=? where contactno=?";
        ...
        try {
           ...
           // ps.setInt(1, Integer.parseInt(txtPid.getText().trim()));
            ...
            ps.setString(5,TxtappdocQualification.getText().trim());
   ...
   public void resate(){
     ...
     TxtappdocQualification.setText(null);
    ...
    private void initComponents() {
        ...
        jPanel10.add(txtpascontact, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 90, 150, -1));
        ...
        jPanel10.add(jScrollPane5, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 20, 370, 240));
        ...
        jPanel10.add(TxtappdocQualification, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 240, 150, -1));
    ...
    private void btnappoaddMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnappoaddMouseClicked
        ...
        try {
            ...
            ps.setString(6, TxtappdocQualification.getText().trim());
            ps.setString(7, TxtappdocQualification.getText().trim());
            ps.setString(8,comboVisitingtime.getSelectedItem().toString());
    ...
    private void tblappointmentMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblappointmentMouseClicked
        ...
        TxtappdocQualification.setText(docqualificarion);
    ...
    private javax.swing.JTextField TxtappdocQualification;
